...
function App() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mt-12">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
              כל פרויקט בנייה או שיפוץ דורש תכנון מדויק וביצוע מקצועי. כל עיכוב
              עלול לעלות יקר. מצד אחד, אתם רוצים באופן טבעי פתרון מהיר מאוד. מצד
              שני, ברור שאי אפשר להתפשר על האיכות.
            </p>

            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
              <span className="font-bold text-orange-600">בזכות FixMen</span>{" "}
              אתם יכולים לסמן ✓ גם על הזריזות וגם על היסודיות.
            </p>

            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              עם ותק של <span className="font-bold">למעלה מעשור בתחום</span>,
          ...
          <div className="mt-12 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl shadow-xl p-8 md:p-10 text-white">
            <p className="text-lg md:text-xl leading-relaxed">
              גם כשנדרש תיקון דחוף וגם כשמדובר על פרויקט חדש, השלב הראשון הוא
              בחינה יסודית ומקיפה של המצב הקיים. לאחר מכן תקבלו מאיתנו הסברים
              ברורים ומפורטים לגבי הדרכים השונות להגיע למצב הרצוי –{" "}
              <span className="font-bold">
                כדי שתוכלו לקבל את ההחלטה הנכונה ביותר עבורכם.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-slate-50 rounded-xl p-6 hover:shadow-lg transition border-2 border-transparent hover:border-orange-300"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-700">
                תגובה מהירה והגעה לאתר בזמן הקצר ביותר
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700">
                ביצוע מקצועי ואחריות מלאה על כל עבודה
              </p>
            </div>
      ...
      <section
        id="contact"
        className="bg-gradient-to-r from-orange-500 to-orange-600 py-16 md:py-24"
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            <a
              href={`tel:${phoneNumber}`}
              className="bg-white text-orange-600 px-8 py-4 rounded-lg hover:bg-gray-100 transition font-bold text-lg"
            >
              📞 {phoneNumber}
            </a>
            <a
            ...
            <a
              href="mailto:info@fixmen.co.il"
              className="bg-orange-700 text-white px-8 py-4 rounded-lg hover:bg-orange-800 transition font-bold text-lg"
            >
              ✉️ info@fixmen.co.il
            </a>
          </div>
